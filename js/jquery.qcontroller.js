...
(function($){
      ...
      var setting = $.extend({
                 ...
                 qStatus: "Qty: ", //text that will show along with the quantity status
  		   }, options);
...
/* Creating UI elements for quantity controller */
    ...
    qPlus = document.createElement("div");
    qMinus = document.createElement("div");
    qStat = document.createElement("div");
...
/* Adding classes to minus, plus buttons and controller for later customization */
  $(qMinus).addClass("plus").html("+");
  $(qPlus).addClass("minus").html("-"); 
